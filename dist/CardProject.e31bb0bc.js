...
},{"_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/bootstrap/dist/js/bootstrap.bundle.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var dataRow;
var score = 1000;
var recordVal = localStorage.getItem("record");
var nCards; //localStorage["record"]=0; //quest serve per azzerare il record

(0, _jquery.default)(document).ready(function () {
  //chiamata ad un api esterna, in questo caso un file json
  (0, _jquery.default)('#score').text("Score: " + score);
  (0, _jquery.default)('#record').text("Record: " + recordVal);
  fetch('http://localhost:3000/cards') //dopo che trovaerà il file
  .then(function (result) {
    return result.json();
  }) //lo metterà nel result, con result.json mi prenderò solo il file json
  .then(function (data) {
    cardsData = data.cardList;
    dataCol = data.nCols;
    dataRow = data.nRows; //console.log(cardsData);
...
var shakeCards = function shakeCards() {
  var random = 0;
  var aux = 0;
...
var createCardsData = function createCardsData(data) {
  shakeCards(); //assim chamo shuffle com cartas apenas criadas ja faco shuffle do cards Data e n do json

  var cardList = cardsData;
  var nCols = dataCol;
  var nRows = dataRow; //console.log(cardList);
  //console.log("righe: " + nRows + " colonne: " + nCols);

  var boardHtml = "";

  for (var i = 0; i < nRows; i++) //com un for coloca td dentro de boardHtml
  {
    ...
    for (var j = 0; j < nCols; j++) {
      ...
      boardHtml += "\n           <div class=\"d-flex justify-content-center\">\n               <div class=\"whiteCard d-flex justify-content-center\" style=\"background-image:url(".concat(data.frontCover, ")\">\n                    <div class=\"cardValue\" value=").concat(cardList[i * nCols + j].value, " style=\"background-image:url(").concat(cardList[i * nCols + j].backCover, ")\"></div>                    \n               </div>\n           </div>\n           ");
      boardHtml += "</div>";
    }
  ...
  (0, _jquery.default)('#board').append(boardHtml);
}; //funcao que gira cartas


function clickCard() {
  var waitHiding = false;
  var cardVal1 = 0;
  var cardVal2 = 0;
  var firstCard;
  var secondCard;
  var countCouple = 0; //varibile che conta le coppie e usata salvattaggio  

  (0, _jquery.default)('.whiteCard').on('click', function (item) {
    if ((0, _jquery.default)(item.currentTarget).children().is(':hidden') && waitHiding == false) {
      (0, _jquery.default)(item.currentTarget).children().show();

      if (cardVal1 == 0 && cardVal2 == 0) {
        cardVal1 = (0, _jquery.default)(item.currentTarget).children()[0].attributes[1].nodeValue;
        firstCard = (0, _jquery.default)(item.currentTarget).children();
      } else if (cardVal1 != 0 && cardVal2 == 0) {
        cardVal2 = (0, _jquery.default)(item.currentTarget).children()[0].attributes[1].nodeValue;
        secondCard = (0, _jquery.default)(item.currentTarget).children();

        if (cardVal1 == cardVal2) {
          //Controllo se carte sono uguali //aki devemos controlar con un cont o numero di duplas
          countCouple += 1;
          console.log(countCouple);

          if (countCouple >= nCards / 2) {
            //uso nCards pq tem o prblema do Resposive se cambia il numero di collone json
            if (score > recordVal) {
              recordVal = score;
              (0, _jquery.default)('#record').text("Record: " + recordVal);
            }
          ...
          setTimeout(function () {
            ...
            if (score > 5) {
              ...
              alert("Hai perso!!!"); //mettere refresh della page
            }
          }, 1000);
        }
      }
...
},{"jquery":"node_modules/jquery/dist/jquery.js","bootstrap/dist/css/bootstrap.min.css":"node_modules/bootstrap/dist/css/bootstrap.min.css","bootstrap/dist/js/bootstrap.bundle.min":"node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/CardProject.e31bb0bc.js.map